...
class Genere(models.Model):
    ...
    nome = models.CharField(
        max_length=200, help_text='Inserisci il genere (es: fantascienza)')
...
class Libro(models.Model):
    ...
    sommario = models.TextField(
        max_length=1000, help_text='Inserisci una breve descrizione del libro.')
    isbn = models.CharField(
        "ISBN", max_length=13, help_text='13 caratteri <a href="https://www.isbn-international.org/content/what-isbn"> ISBN </a>')

    genere = models.ManyToManyField(
        Genere, help_text="Scegli il genere per questo libro.")
    autore = models.ForeignKey('Autore', on_delete=models.SET_NULL, null=True)
    lingua = models.ForeignKey(
        'Lingua', help_text="Lingua", on_delete=models.SET_NULL, null=True)
...
class Istanza(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4,
                          help_text="ID univoco di uno specifico libro nella biblioteca.")
    libro = models.ForeignKey(Libro, on_delete=models.SET_NULL, null=True)
    imprint = models.CharField(
        max_length=200, help_text="Non so cosa sia in effetti...")
    ...
    @property
    def is_overdue(self):
        if self.riconsegna and date.today() > self.riconsegna:
            return True
        return False
...
class Lingua(models.Model):
    ...
    nome = models.CharField(
        max_length=100, help_text="Inserisci il nome di una lingua, es. inglese, italiano...")
